...
# 景点介绍为60-70中文字客观且更有吸引力，面向非中国游客，避免民族或宏大叙事，仅基于地点名称与报价上下文。
DAYS = [
    {
        'day': 'Day 1',
        'route': '新加坡/深圳',
    ...
    },
    {
        ...
        'sights': [
            ...
            ('品清湖', '品清湖是汕尾市区一处开阔宁静的天然湖泊，湖面宽广平静如镜，夜晚华灯映照下水面波光籁籁，游客沿着湖畔步道漫步，能充分欣赏那迷人的湖光夜色。'),
        ],
    ...
    },
    {
        ...
        'meals': '午：海丰风味｜晚：自理',
        'summary': '参观海丰红宫红场旧址纪念馆、彭湘烈士故居，午餐后前往凤山民俗文化旅游区（非遗展演已经没有了，改凤山），逛二马路。',
        'sights': [
            ('海丰红宫红场旧址纪念馆', '海丰红宫红场旧址纪念馆由一组保存完好的历史建筑群构成，馆内通过丰富展览详细介绍当地历史人物彭湘的事迹及其故居，游客可在这里深入了解这段往昔的历史。'),
            ('彭湘烈士故居', '彭湘烈士故居是一座保存完整的传统民居建筑，内部陈列着大量历史文物和生活用品，游客参观时能够真切感受到当地过去普通居民的居住环境和生活方式。'),
    ...
    },
    {
        ...
        'meals': '午：陆丰风味｜晚：牛肉火锅',
        'summary': '前往陆丰，游览玄武山、定光禅寺、金帅银滩。',
        'sights': [
            ('玄武山', '玄武山是陆丰地区著名的山地自然景区，山体起伏绵延，山顶建有古寺庙宇，游客沿着媛延山径等山而上，可一边欣赏沿途茂密林木，一边俯瞰周围壮丽的自然山林景色。'),
            ('定光禅寺', '定光禅寺是陆丰一座历史游久的佛教寺院，寺内殿堂建筑古朴壮重，院落布局清幺整洁，环境宁静祥和，游客在此可以悠闲参观，感受传统佛教文化的宁静氛围。'),
            ('金帅银滩', '金帅银滩位于陆丰沿海地带，是面积开阔的优质沙滩景区，沙质洁白细腻，海水清澈透明，游客可以在宽阔的沙滩上自由散步，感受海风拂面和海浪轻拍的悠意。'),
        ],
        'hotel': '维也纳国际豪华房（城区店，四星）',
    },
    {
        ...
        'meals': '午：客家风味（客家酿豆腐、掴茶、咸鸡）｜晚：全牛宴',
        'summary': '前往陆河螺洞世外梅园景区、九厅十八井客家古民居，后返回汕尾与侨联谈。',
        'sights': [
    ...
    },
    {
        ...
        'sights': [
            ('晨洲蚝乡', '晨洲蚝乡是汕尾沿海著名的牡蛤养殖村落，村子紧邻大海，游客可以走进蚝田区域近距离观察养殖过程，了解当地渔民世代相传的水产养殖技艺和海边特有的产业生活景象。'),
        ],
        'hotel': None,  # 返程日无宿
    },
]
...
def build(outputs: list[Path]):
    ...
    # 只有报价明确有的赠送（无独家安排 / 各地美食 区块，因报价未提供）
    ...
    add_para(
        ...
        '汕尾陆河往返日 午客家风味（客家酿豆腐、掴茶、咸鸡）、晚全牛宴；返程日 午全蚝宴。',
    ...
    add_para(doc, '联系人：姚文跃（13600926388） 李珰（13950127910）',
